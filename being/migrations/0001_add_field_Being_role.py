...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Being.role'
        db.add_column(u'being_being', 'role',
                      self.gf('django.db.models.fields.CharField')(default='student', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Being.role'
        db.delete_column(u'being_being', 'role')
    ...
    models = {
        ...
        u'being.being': {
            ...
            'weibo': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'weixin': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'})
        },

...
class UpdateBeingForm(forms.ModelForm):
    class Meta:
        model = Being
        fields = ('description','occupation','birthday', 'face','gender','telephone','qq','weixin','truename','weibo')
        widgets={
...
class NewBeingForm(forms.ModelForm):
    class Meta:
        model = Being
        fields = ('face','gender','birthday','description','telephone','qq','weixin','truename','weibo')
        widgets={
